    ...
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{
          ...
          Join thousands<br />of golfers 🏌️
        </h2>
        <p style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          {[
            { icon: '🎯', text: 'Enter monthly prize draws automatically' },
            { icon: '💚', text: 'Support your chosen charity every month' },
            { icon: '🏆', text: 'Win up to 40% of the monthly prize pool' },
            { icon: '📊', text: 'Track your scores and performance' }
          ].map((item, i) => (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
              ...
              <div style={{ display: 'flex', gap: '0.8rem', marginTop: '0.5rem' }}>
                ...
                <button
                  ...
                  disabled={loading}
                  style={{
                    flex: 2, background: loading ? '#a78bfa' : '#6c63ff',
                    color: '#fff', border: 'none',
                    padding: '0.85rem', borderRadius: '8px',
